...
Обновления в этой версии:
 ...
 - В режиме редактирования профиля теперь показываются изменения с помощью стрелочек (старое → новое значение)
                ...
                try:
                    ...
                    if tp == '1':
                        ...
                        settings = {
                            ...
                            'action_mode': mode,
                            'monitor_disk': False,
                            'monitor_disk_type': 'all'
                        }
                        
                        if monitor_disk_choice == 'y':
                            settings['monitor_disk'] = True
                            print("\n=== Настройка мониторинга дисков ===")
                            print("1. Мониторинг всех дисков (общая активность)")
                            print("2. Мониторинг конкретного диска")
                            disk_mon_type = input("Выберите тип мониторинга (1/2) [1]: ") or '1'
                        ...
                        if disk_letter is not None:  # конкретный диск
